                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                                <div class="card bg-primary img-card box-primary-shadow">
                                    <a href="https://www.cgccms.in/attendifi/erp/manage-users">
                                    <div class="card-body">
                                        <div class="d-flex">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                                <a href="https://www.cgccms.in/attendifi/erp/add-student">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                                <div class="card  bg-success img-card box-success-shadow">
                                    <a href="https://www.cgccms.in/attendifi/erp/manage-batches">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="text-white">
                            ...
                            <!-- COL END -->
                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-3">
                                <a href="https://www.cgccms.in/attendifi/erp/manage-subjects">
